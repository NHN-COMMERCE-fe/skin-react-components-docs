/*! For license information please see dist-esm-common-InfiniteScrollLoader-InfiniteScrollLoader-stories.83e4ef9b.iframe.bundle.js.LICENSE.txt */
'use strict';
(self.webpackChunk_shopby_react_components = self.webpackChunk_shopby_react_components || []).push([
  [7027],
  {
    './dist/esm/common/InfiniteScrollLoader/InfiniteScrollLoader.stories.js': (
      ...
      __webpack_require__.r(__webpack_exports__),
        __webpack_require__.d(__webpack_exports__, {
          ...
          default: () => InfiniteScrollLoader_stories,
        });
      ...
      var jsx_runtime = __webpack_require__('../../node_modules/react/jsx-runtime.js'),
        ...
        debounce = __webpack_require__('../../node_modules/lodash-es/debounce.js');
      ...
      var DEFAULT_OPTION = { rootMargin: '1px', threshold: 1 };
      const InfiniteScrollLoader_InfiniteScrollLoader = function InfiniteScrollLoader(_ref) {
        var rootRef = _ref.rootRef,
          onIntersect = _ref.onIntersect,
          _ref$disabled = _ref.disabled,
          disabled = void 0 !== _ref$disabled && _ref$disabled,
          _ref$option = _ref.option,
          option = void 0 === _ref$option ? DEFAULT_OPTION : _ref$option,
          _ref$debounceTime = _ref.debounceTime,
          debounceTime = void 0 === _ref$debounceTime ? 200 : _ref$debounceTime,
          targetRef = (0, react.useRef)(null),
          debounceOnIntersect = onIntersect
            ? (0, debounce.Z)(function () {
                null == onIntersect || onIntersect();
              }, debounceTime)
            : null,
          observerCallback = (0, react.useCallback)(
            function (_ref2) {
              _slicedToArray(_ref2, 1)[0].isIntersecting &&
                !disabled &&
                (null == debounceOnIntersect || debounceOnIntersect());
            },
        ...
        return (
          (0, react.useEffect)(
            function () {
              var observer = new IntersectionObserver(
                observerCallback,
                Object.assign({}, option, { root: null == rootRef ? void 0 : rootRef.current })
              );
              return (
          ...
          (0, jsx_runtime.jsx)('div', { ref: targetRef, className: 'infinite-scroll-loader' })
        );
      };
      function InfiniteScrollLoader_stories_slicedToArray(arr, i) {
        return (
          (function InfiniteScrollLoader_stories_arrayWithHoles(arr) {
            if (Array.isArray(arr)) return arr;
          })(arr) ||
          (function InfiniteScrollLoader_stories_iterableToArrayLimit(arr, i) {
            var _i = null == arr ? null : ('undefined' != typeof Symbol && arr[Symbol.iterator]) || arr['@@iterator'];
            if (null != _i) {
              var _s,
                _e,
          ...
          (function InfiniteScrollLoader_stories_unsupportedIterableToArray(o, minLen) {
            if (!o) return;
            if ('string' == typeof o) return InfiniteScrollLoader_stories_arrayLikeToArray(o, minLen);
            var n = Object.prototype.toString.call(o).slice(8, -1);
            'Object' === n && o.constructor && (n = o.constructor.name);
            if ('Map' === n || 'Set' === n) return Array.from(o);
            if ('Arguments' === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n))
              return InfiniteScrollLoader_stories_arrayLikeToArray(o, minLen);
          })(arr, i) ||
          (function InfiniteScrollLoader_stories_nonIterableRest() {
            throw new TypeError(
              'Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.'
            );
          })()
      ...
      function InfiniteScrollLoader_stories_arrayLikeToArray(arr, len) {
        (null == len || len > arr.length) && (len = arr.length);
        for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i];
        return arr2;
      }
      const InfiniteScrollLoader_stories = {
        title: 'common/InfiniteScrollLoader',
        component: InfiniteScrollLoader_InfiniteScrollLoader,
      };
      var TestItem = function TestItem(_ref) {
          var id = _ref.id;
          return (0, jsx_runtime.jsx)(jsx_runtime.Fragment, {
            children: (0, jsx_runtime.jsxs)('div', {
              ...
              children: [id, ' 번째 테스트 요소입니다. ', (0, jsx_runtime.jsx)('br', {})],
            }),
          });
        },
        Default = function Default() {
          var wrapperRef = (0, react.useRef)(null),
            _useState2 = InfiniteScrollLoader_stories_slicedToArray((0, react.useState)(6), 2),
            amount = _useState2[0],
            setAmount = _useState2[1],
            _useState4 = InfiniteScrollLoader_stories_slicedToArray((0, react.useState)(!1), 2),
            disabled = _useState4[0],
            setDisabled = _useState4[1];
          return (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
            children: [
              (0, jsx_runtime.jsx)('h1', { children: '6개씩 최대 24개를 노출하는 무한 스크롤 테스트입니다. ' }),
              ...
              (0, jsx_runtime.jsxs)('div', {
                ...
                children: [
                  Array(amount)
                    .fill(0)
                    .map(function (_, idx) {
                      return (0, jsx_runtime.jsx)(TestItem, { id: idx + 1 }, idx);
                    }),
                  (0, jsx_runtime.jsx)(InfiniteScrollLoader_InfiniteScrollLoader, {
                    rootRef: wrapperRef,
      ...
      Default.parameters = Object.assign(
        {
          storySource: {
            source:
              '() => {\n    const wrapperRef = useRef(null);\n    const [amount, setAmount] = useState(6);\n    const [disabled, setDisabled] = useState(false);\n    const handleIntersect = () => {\n        setDisabled(true);\n        if (amount === 24)\n            return;\n        setAmount((prev) => prev + 6);\n        setDisabled(false);\n    };\n    return (_jsxs(_Fragment, { children: [_jsx("h1", { children: "6\\uAC1C\\uC529 \\uCD5C\\uB300 24\\uAC1C\\uB97C \\uB178\\uCD9C\\uD558\\uB294 \\uBB34\\uD55C \\uC2A4\\uD06C\\uB864 \\uD14C\\uC2A4\\uD2B8\\uC785\\uB2C8\\uB2E4. " }), _jsx("br", {}), _jsxs("div", { ref: wrapperRef, style: { height: \'500px\', overflowY: \'scroll\' }, children: [Array(amount)\n                        .fill(0)\n                        .map((_, idx) => (_jsx(TestItem, { id: idx + 1 }, idx))), _jsx(InfiniteScrollLoader, { rootRef: wrapperRef, onIntersect: handleIntersect, disabled: disabled })] })] }));\n}',
          },
        },
        Default.parameters
      );
    ...
    '../../node_modules/lodash-es/debounce.js': (
      ...
      __webpack_require__.d(__webpack_exports__, { Z: () => lodash_es_debounce });
      ...
      const lodash_es_toNumber = function toNumber(value) {
        ...
        if ((0, isSymbol.Z)(value)) return NAN;
