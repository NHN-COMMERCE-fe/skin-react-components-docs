    ...
    './common/CharacterCounter/CharacterCounter.stories.tsx': (
      ...
      try {
        (TextArea.displayName = 'TextArea'),
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['common/TextArea/TextArea.tsx#TextArea'] = {
              docgenInfo: TextArea.__docgenInfo,
              name: 'TextArea',
              path: 'common/TextArea/TextArea.tsx#TextArea',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      var TextField = __webpack_require__('./common/TextField/TextField.tsx'),
        VisibleComponent = __webpack_require__('./common/VisibleComponent/VisibleComponent.tsx'),
      ...
      try {
        (CharacterCounter.displayName = 'CharacterCounter'),
          (CharacterCounter.__docgenInfo = {
            ...
            props: {
              ...
              textType: {
                ...
                name: 'textType',
                required: !1,
                type: { name: 'enum', value: [{ value: '"INPUT"' }, { value: '"TEXT_AREA"' }] },
              },
              counterType: {
                defaultValue: null,
                description: '',
                name: 'counterType',
                required: !1,
                type: { name: 'enum', value: [{ value: '"WORD"' }, { value: '"CHARACTER"' }] },
              },
              limitCount: {
                defaultValue: { value: '{ word: 0, character: 0 }' },
                description: '',
                name: 'limitCount',
                required: !1,
                type: { name: 'LimitCount' },
              },
              onChange: {
                defaultValue: null,
                description: '',
                name: 'onChange',
                required: !1,
                type: { name: '((param: TextCountStatus) => void)' },
              },
              onBlur: {
                defaultValue: null,
                description: '',
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['common/CharacterCounter/CharacterCounter.tsx#CharacterCounter'] = {
              docgenInfo: CharacterCounter.__docgenInfo,
              name: 'CharacterCounter',
              path: 'common/CharacterCounter/CharacterCounter.tsx#CharacterCounter',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      ...
      var CharacterTemplate = Template.bind({});
