...
(self.webpackChunk_shopby_react_components = self.webpackChunk_shopby_react_components || []).push([
  [8385],
  {
    './manage/SearchAddressProvider/SearchAddressProvider.stories.tsx': (
      ...
      var handlers = __webpack_require__('../shared/dist/esm/msw/handlers/index.js'),
        AddressItem = __webpack_require__('./manage/AddressItem/AddressItem.tsx'),
        SearchField = __webpack_require__('./common/SearchField/SearchField.tsx'),
        react =
      ...
      var _manageHelper$address = helpers.aV.address,
        ...
        SearchAddressProvider = function SearchAddressProvider(_ref) {
                        ...
                        setSearchResult(function (prev) {
                          var _prev$items,
                            items = usesAccumulation
                              ? [].concat(
                                  _toConsumableArray(
                                    null !== (_prev$items = null == prev ? void 0 : prev.items) &&
                                      void 0 !== _prev$items
                                      ? _prev$items
                                      : []
                                  ),
      ...
      SearchAddressProvider.displayName = 'SearchAddressProvider';
      var useSearchAddressStateContext = function useSearchAddressStateContext() {
        var context = (0, react.useContext)(SearchAddressStateContext);
        if (!context) throw new Error('INVALID_SearchAddressStateContext');
        return context;
      };
      const SearchAddressProvider_SearchAddressProvider = SearchAddressProvider;
      try {
        (SearchAddressProvider.displayName = 'SearchAddressProvider'),
          (SearchAddressProvider.__docgenInfo = {
            description: '',
            displayName: 'SearchAddressProvider',
            props: {
              onClientError: {
                defaultValue: null,
                description: '',
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['manage/SearchAddressProvider/SearchAddressProvider.tsx#SearchAddressProvider'] = {
              docgenInfo: SearchAddressProvider.__docgenInfo,
              name: 'SearchAddressProvider',
              path: 'manage/SearchAddressProvider/SearchAddressProvider.tsx#SearchAddressProvider',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      var SearchAddressForm = function SearchAddressForm(_ref) {
      ...
      SearchAddressForm.displayName = 'SearchAddressForm';
      const SearchAddressForm_SearchAddressForm = SearchAddressForm;
      try {
        (SearchAddressForm.displayName = 'SearchAddressForm'),
          (SearchAddressForm.__docgenInfo = {
            description: '',
            displayName: 'SearchAddressForm',
            props: {
              initialKeyword: {
                defaultValue: null,
                description: '',
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['manage/SearchAddressForm/SearchAddressForm.tsx#SearchAddressForm'] = {
              docgenInfo: SearchAddressForm.__docgenInfo,
              name: 'SearchAddressForm',
              path: 'manage/SearchAddressForm/SearchAddressForm.tsx#SearchAddressForm',
            });
      } catch (__react_docgen_typescript_loader_error) {}
      ...
      SearchAddressProviderExample.displayName = 'SearchAddressProviderExample';
      ...
      (Example.parameters = { msw: { handlers: [handlers.bY] } }),
        (Example.parameters = Object.assign(
          { storySource: { source: '() => <SearchAddressProviderExample />' } },
          Example.parameters
        ));
