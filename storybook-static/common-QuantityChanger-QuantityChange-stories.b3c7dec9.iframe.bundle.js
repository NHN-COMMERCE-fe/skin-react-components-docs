  ...
  [1297],
  {
    './common/QuantityChanger/QuantityChange.stories.tsx': (
      ...
      var filterQuantity = function filterQuantity(_ref) {
          ...
          return (
            confirmedValue > max && (confirmedValue = max),
            confirmedValue < min && (confirmedValue = min),
            confirmedValue
          );
        },
        QuantityChanger = function QuantityChanger(_ref2) {
      ...
      QuantityChanger.displayName = 'QuantityChanger';
      const QuantityChanger_QuantityChanger = QuantityChanger;
      try {
        (QuantityChanger.displayName = 'QuantityChanger'),
          (QuantityChanger.__docgenInfo = {
            description: '',
            displayName: 'QuantityChanger',
            props: {
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['common/QuantityChanger/QuantityChanger.tsx#QuantityChanger'] = {
              docgenInfo: QuantityChanger.__docgenInfo,
              name: 'QuantityChanger',
              path: 'common/QuantityChanger/QuantityChanger.tsx#QuantityChanger',
            });
      ...
      (Default.displayName = 'Default'),
        (Default.parameters = Object.assign(
          { storySource: { source: '(args) => <QuantityChanger {...args} />' } },
          Default.parameters
        ));
