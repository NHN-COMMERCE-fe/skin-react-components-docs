/*! For license information please see dist-esm-common-Badge-Badge-stories.9b3ea65a.iframe.bundle.js.LICENSE.txt */
'use strict';
(self.webpackChunk_shopby_react_components = self.webpackChunk_shopby_react_components || []).push([
  [1675],
  {
    './dist/esm/common/Badge/Badge.stories.js': (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      const Badge_Badge = function Badge(_ref) {
      ...
      (Round.args = { label: '상품태그', badgeType: 'round', colorType: 'line' }),
        (Square.parameters = Object.assign(
          { storySource: { source: '(args) => _jsx(Badge, { ...args })' } },
          Square.parameters
        )),
