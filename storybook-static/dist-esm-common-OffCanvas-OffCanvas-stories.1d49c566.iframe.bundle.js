/*! For license information please see dist-esm-common-OffCanvas-OffCanvas-stories.1d49c566.iframe.bundle.js.LICENSE.txt */
(self.webpackChunk_shopby_react_components = self.webpackChunk_shopby_react_components || []).push([
  [5398],
  {
    './dist/esm/common/OffCanvas/OffCanvas.stories.js': (
      ...
      const OffCanvas_OffCanvasProvider = function OffCanvasProvider(_ref) {
      ...
      const OffCanvas_OffCanvas = function OffCanvas(_ref) {
      ...
      Default.parameters = Object.assign(
        {
          storySource: {
            source:
              '() => (_jsx(Router, { children: _jsxs(OffCanvasProvider, { children: [_jsx(MockContent, {}), _jsx(OffCanvas, { children: _jsx("p", { className: "l-panel", children: "hello" }) })] }) }))',
          },
        },
        Default.parameters
      );
