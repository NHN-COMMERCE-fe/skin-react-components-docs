/*! For license information please see 2816.436fcabb.iframe.bundle.js.LICENSE.txt */
  ...
  [2816],
  {
    ...
    '../../node_modules/@storybook/components/dist/esm/index-681e4b07.js': (
      ...
      var curriedTransparentize = curry(transparentize),
        ...
        StyledSyntaxHighlighter = (0, _storybook_theming__WEBPACK_IMPORTED_MODULE_55__.zo)(SyntaxHighlighter)(function (
          _ref8
        ) {
      ...
      var selectedKey = function selectedKey(value, options) {
        ...
        CheckboxControl = function CheckboxControl(_ref153) {
          ...
          if (!options)
            return (
              _storybook_client_logger__WEBPACK_IMPORTED_MODULE_56__.logger.warn(
      ...
      var Text = _storybook_theming__WEBPACK_IMPORTED_MODULE_55__.zo.span({}),
        ...
        OptionsControl = function OptionsControl(props) {
          ...
          options &&
            _storybook_client_logger__WEBPACK_IMPORTED_MODULE_56__.once.warn(
              dedent(
                _templateObject4 ||
      ...
      var sortFns = {
        ...
        safeIncludeConditionalArg = function safeIncludeConditionalArg(row, args, globals) {
          try {
            ...
            return _storybook_client_logger__WEBPACK_IMPORTED_MODULE_56__.once.warn(err.message), !1;
          }
        },
        ArgsTable = function ArgsTable(props) {
          if ('error' in props)
    ...
    '../../node_modules/@storybook/theming/dist/esm/index.js': (
      ...
      function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length) {
        ...
        return node(value, root, parent, 0 === offset ? RULESET : type, props, children, length);
      }
          ...
          return function (color) {
            if (
              !(function isColorString(color) {
                return (
                  'string' == typeof color ||
                  (_storybook_client_logger__WEBPACK_IMPORTED_MODULE_39__.logger.warn(
    ...
    '../../node_modules/core-js/internals/array-buffer.js': (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      var global = __webpack_require__('../../node_modules/core-js/internals/global.js'),
        ...
        getInternalArrayBufferState = InternalStateModule.getterFor('ArrayBuffer'),
        ...
        set = function (view, count, index, conversion, value, isLittleEndian) {
          ...
          if (intIndex + count > store.byteLength) throw RangeError('Wrong index');
          for (
            var bytes = store.bytes, start = intIndex + store.byteOffset, pack = conversion(+value), i = 0;
            i < count;
            i++
          )
      ...
      if (NATIVE_ARRAY_BUFFER) {
        ...
        (ArrayBufferPrototype = ($ArrayBuffer = function ArrayBuffer(length) {
          ...
          setInternalState(this, { type: 'ArrayBuffer', bytes: fill(Array(byteLength), 0), byteLength }),
    ...
    '../../node_modules/core-js/modules/es.array.splice.js': (
      ...
      var $ = __webpack_require__('../../node_modules/core-js/internals/export.js'),
        ...
        setArrayLength = __webpack_require__('../../node_modules/core-js/internals/array-set-length.js'),
