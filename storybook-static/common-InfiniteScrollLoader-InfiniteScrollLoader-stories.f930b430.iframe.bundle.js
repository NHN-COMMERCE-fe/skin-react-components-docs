  ...
  [5343],
  {
    './common/InfiniteScrollLoader/InfiniteScrollLoader.stories.tsx': (
      ...
      var DEFAULT_OPTION = { rootMargin: '1px', threshold: 1 },
        InfiniteScrollLoader = function InfiniteScrollLoader(_ref) {
      ...
      const InfiniteScrollLoader_InfiniteScrollLoader = InfiniteScrollLoader;
      try {
        (InfiniteScrollLoader.displayName = 'InfiniteScrollLoader'),
          (InfiniteScrollLoader.__docgenInfo = {
            description: '',
            ...
            props: {
              rootRef: {
                ...
                name: 'rootRef',
                required: !0,
                type: { name: 'RefObject<RootElement>' },
              },
              onIntersect: {
                defaultValue: null,
                description: '',
              ...
              option: {
                ...
                name: 'option',
                required: !1,
                type: { name: 'InfiniteScrollLoaderOption' },
              },
              debounceTime: {
          ...
          'undefined' != typeof STORYBOOK_REACT_CLASSES &&
            (STORYBOOK_REACT_CLASSES['common/InfiniteScrollLoader/InfiniteScrollLoader.tsx#InfiniteScrollLoader'] = {
              docgenInfo: InfiniteScrollLoader.__docgenInfo,
              name: 'InfiniteScrollLoader',
              path: 'common/InfiniteScrollLoader/InfiniteScrollLoader.tsx#InfiniteScrollLoader',
            });
